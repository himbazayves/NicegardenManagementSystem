...
{{-- @extends('layouts.app', ['page' => 'List of Providers', 'pageSlug' => 'providers', 'section' => 'providers']) --}}
@extends('layouts.app', ['page' => __('Request Management'), 'pageSlug' => 'download_request', 'section' => 'requests'])
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-4">
                            <h3 class="mb-0">Download request</h3>
                        </div>

                        <div class="col-4">
                            <input class="btn btn-sm btn-primary" type="button" id="create_pdf" value="download">
                        </div>
                        <div class="col-4 text-right">
