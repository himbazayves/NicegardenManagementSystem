@extends('layouts.app', ['page' => 'Edit ProductList', 'pageSlug' => 'productsList', 'section' => 'inventory'])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('productsList.update', $product->id) }}" autocomplete="off">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="col-6">                                    
                                        <div class="form-group{{ $errors->has('product_measurement_id') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="product_measurement_id" id="product_measurement_id" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" required>
                                                ...
                                                @if($measurement['id'] == old('document') or $measurement['id'] == $product->product_mesaurement_id)
