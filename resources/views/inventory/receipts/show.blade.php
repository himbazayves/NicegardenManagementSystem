                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{!! $receipt->finalized_at ? 'Finalized' : '<span
                                    style="color:red; font-weight:bold;">TO FINALIZE</span>' !!}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="table">
                    ...
                    {{-- calculate total amount for products --}}
                     ...
                     {{-- Calculate amount for each product --}}
                        @php
                        $amount=0;
                        $amount= $amount+ $received_product->stock * $received_product->product->price;
                        $totalAmount=$totalAmount+$amount;
                        @endphp

                        
                     {{-- end of Calculate amount for each product --}}
                        <tr>
                            <td><a
                        ...
                        <tr>
                            <td colspan="6">Total amount : Frw {{$totalAmount}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
